...
MD_MAX72XX::fontType_t ExtASCII[] PROGMEM =
{
  ...
  1, 64,		                // 46 - '.' 2, 96, 96,
  5, 32, 16, 8, 4, 2,		    // 47 - '/'
  3, 62, 34, 62,        		// 48 - '0' 5, 62, 81, 73, 69, 62,
  3, 36, 62, 32, 		        // 49 - '1' 3, 66, 127, 64,
  3, 58, 42, 46,        		// 50 - '2' 5, 114, 73, 73, 73, 70,
  3, 42, 42, 62,        		// 51 - '3' 5, 33, 65, 73, 77, 51,
  3, 14, 8, 62,         		// 52 - '4' 5, 24, 20, 18, 127, 16,
  3, 46, 42, 58,        		// 53 - '5' 5, 39, 69, 69, 69, 57,
  3, 62, 42, 58,        		// 54 - '6' 5, 60, 74, 73, 73, 49,
  3, 2, 2, 62,      		    // 55 - '7' 5, 65, 33, 17, 9, 7,	
  3, 62, 42, 62,        		// 56 - '8' 5, 54, 73, 73, 73, 54,
  3, 46, 42, 62,        		// 57 - '9' 5, 70, 73, 73, 41, 30,
  1, 20,		                // 58 - ':'
  2, 128, 104,		            // 59 - ';'
  4, 8, 20, 34, 65,		        // 60 - '<'
  5, 20, 20, 20, 20, 20,		// 61 - '='
  ...
  5, 2, 1, 89, 9, 6,		    // 63 - '?'
  5, 62, 65, 93, 89, 78,		// 64 - '@'
  3, 62, 10, 62,        		// 65 - 'A' 5, 124, 18, 17, 18, 124,
  ...
  3, 65, 54, 8,		            // 125 - '}'
  5, 2, 1, 2, 4, 2,		        // 126 - '~'
  6, 220, 48, 112, 72, 64, 0,   // 127 - 'SatDish'  5, 28, 48, 112, 72, 64,  *
  6, 20, 62, 85, 85, 65, 34,    // 128 - 'Euro sign'
  6, 1, 26, 28, 12, 16, 32,  	// 129 - 'SatLink'                           *
  ...
  3, 60, 10, 60, 		            // 141 - '3 col A'						  *
  5, 68, 101, 86, 77, 68,		    // 142 - 'z with caron'
  3, 62, 10, 14, 		            // 143 - '3 col P'                        *
  6, 0, 0, 0, 0, 0, 0, 		        // 144 - '6 Empty Col'                    *
  ...
  4, 54, 12, 28, 18,	        // 157 - '4 col Sat dish'				  *
  ...
  4, 18, 12, 12, 16, 		        // 173 - '4 col SatLink'					*
