...
textEffect_t FX[] ={PA_SCROLL_LEFT, PA_OPENING_CURSOR};
...
int h,m,s,d,mth,yy,yyyy,c,mTable,SummedDate,DoW,leap,cTable,i=1,counter=0,j ; 	          
String Mdn,DAYX,TIMEX,DATEX, UTC=" UTC+",LOGO=UTC+zone_hours;     	  
char dayxx[22],timexx[15],datexx[15],logo[15];
...
{ 
 ...
 LOGO = (char(127))+UTC + zone_hours+" "+(char(129)); ;LOGO.toCharArray(logo, 15);
 
 Serial.print(TIMEX);Serial.print(" ,");Serial.print(DAYX);Serial.print(" ,");Serial.println(DATEX);
 DAYX+="  "+ DATEX ; DAYX.toCharArray(dayxx, 22);TIMEX.toCharArray(timexx, 15);
 sequences();
}
...
switch (i) 
  {
     case 1 :P.print(TIMEX);break;  case 2 :P.print(TIMEX);break;  case 3 :P.print(TIMEX);break;
     case 4 :P.print(TIMEX);break;  case 5 :P.print(TIMEX);break;  case 6 :P.print(TIMEX);break;
     case 7 :P.print(TIMEX);break;  case 8 :P.print(TIMEX);break;  case 9 :P.print(TIMEX);break;
     case 10:P.print(TIMEX);break;  case 11:P.print(TIMEX);break;  case 12:P.print(TIMEX);break;
     case 13:P.print(TIMEX);break;  case 14:P.print(TIMEX);break;  case 15:P.print(TIMEX);break;
     case 16:P.print(TIMEX);break;  case 17:P.print(TIMEX);break;  case 18:P.print(TIMEX);break;
     case 19:P.print(TIMEX);break;  case 20:P.print(TIMEX);break;
     case 21:P.displayText(GPS[0],PA_CENTER ,25,5, FX[0], FX[0]);break;
     case 22:P.displayText(GPS[3],PA_CENTER ,5,1000,FX[1],FX[1]);break;
